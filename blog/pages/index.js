...
import IndexStyles from "../static/style/pages/Index.module.css";
      ...
      <Row className="comm-main" type="flex" justify="center">
        ...
        <div>    
          <List
            ...
            renderItem={item => (
              <List.Item>
                <div className={IndexStyles.listTitle}>{item.title}</div>
                <div className={IndexStyles.listIcon}>
                  <span><CalendarOutlined /> 2019-06-28</span>
                  <span><FolderOpenOutlined /> 视频教程</span>
                  <span><FireOutlined /> 5498人</span>
                </div>
                <div className={IndexStyles.listContext}>{item.context}</div>  
              </List.Item>
            )}
          />    
        </div>
